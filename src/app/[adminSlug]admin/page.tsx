...
export default function DedicatedAdminDashboardPage({
  ...
  const adminSlug = resolvedParams.adminSlug?.toLowerCase() || 'nani';
  const adminDisplayName = adminSlug.charAt(0).toUpperCase() + adminSlug.slice(1);
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 flex">
      <AdminSidebar currentRole={`${adminDisplayName}'s Admin`} adminName={adminDisplayName} />
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-base font-black text-slate-950 leading-tight">
                  {adminDisplayName}'s Institutional Folders
                </h1>
                <span className="px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200 text-[11px] font-bold flex items-center space-x-1">
                  ...
                  <span>{adminDisplayName}'s Control Panel</span>
                </span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
              <div>
                <h3 className="text-sm font-black uppercase tracking-wider text-slate-800 flex items-center space-x-2">
                  <span>📁</span>
                  <span>{adminDisplayName}'s Workspaces Directory</span>
                </h3>
