        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="w-full max-w-xl glossy-card rounded-3xl p-8 space-y-6 shadow-xl border border-slate-200/90">
            ...
            <button
              ...
              disabled={verifying}
              className="w-full glossy-button-primary text-white font-black py-4 rounded-2xl text-sm uppercase tracking-wider flex items-center justify-center space-x-2 shadow-lg"
            >
              {verifying ? <Loader2 className="w-5 h-5 animate-spin" /> : <FileCheck2 className="w-5 h-5" />}
              <span>{verifying ? 'Preparing Assessment...' : 'Start Assessment'}</span>
            </button>
          </div>
        </div>
      </main>
          ...
          <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
            <div className="w-full max-w-md glossy-card rounded-3xl p-6 space-y-4 shadow-2xl text-center animate-in fade-in zoom-in-95">
              ...
              <div className="pt-2 flex items-center justify-center space-x-3">
                ...
                >
                  {submitting ? 'Evaluating...' : 'Yes, Submit Exam'}
                </button>
              </div>
            </div>
          </div>
