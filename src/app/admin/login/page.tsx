...
import { Lock, User, KeyRound, AlertCircle, Loader2, ShieldCheck } from 'lucide-react';
        ...
        <div className="p-8 md:p-10">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full glossy-button-primary font-extrabold py-3 px-6 rounded-xl shadow-md text-xs flex items-center justify-center space-x-2 disabled:opacity-60 transition-all uppercase tracking-wider mt-2"
            >
              {loading ? (
                <>
